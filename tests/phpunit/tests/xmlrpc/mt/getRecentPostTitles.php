...
class Tests_XMLRPC_mt_getRecentPostTitles extends WP_XMLRPC_UnitTestCase {
	...
	function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->call( 'mt.getRecentPostTitles', array( 1, 'username', 'password' ) );
	...
	function test_no_posts() {
		...
		$result = $this->myxmlrpcserver->call( 'mt.getRecentPostTitles', array( 1, 'author', 'author' ) );
		$this->assertInstanceOf( 'WP\IXR\Error', $result );
	...
	function test_date() {
		...
		$results = $this->myxmlrpcserver->call( 'mt.getRecentPostTitles', array( 1, 'author', 'author' ) );
