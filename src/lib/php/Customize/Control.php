...
class Control {
	 ...
	 *               \WP\Customize\Control, and returns bool to indicate whether
	 ...
	 *     @type array                $json            Deprecated. Use \WP\Customize\Control::json() instead.
	...
	final public function maybe_render() {
		 ...
		 * @since 3.4.0
		 *
		 * @param \WP\Customize\Control $this \WP\Customize\Control instance.
		 */
