...
class Setting extends BaseSetting {
	...
	protected function update( $value ) {
		...
		if ( 'inserted' === $this->update_status ) {
			...
			foreach ( array_keys( $this->manager->unsanitized_post_values() ) as $setting_id ) {
				...
				$widget_instance = $nav_menu_widget_setting->post_value(); // Note that this calls \WP\Customize\Widget\Manager::sanitize_widget_instance().
	 ...
	 * @access protected
	 *
	 * @see Setting::filter_nav_menu_options()
	 * @see Setting::update()
	 *
