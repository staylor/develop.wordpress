...
class Help extends AdminHelp {
	...
	private function getAddText( $taxnow ) {
		...
		$help .= '<p>' . __( 'You can change the display of this screen using the Screen Options tab to set how many items are displayed per screen and to display/hide columns in the table.' ) . '</p>';
