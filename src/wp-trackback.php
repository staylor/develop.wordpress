...
$trackback_response = function ( $error = 0, $error_message = '' ) use (
	...
	$response->setCharset( $blog_charset );
	$response->headers->set( 'Content-Type', 'text/xml' );

	$xml = $app['mustache']->render( 'trackback/response', [
...
if ( function_exists( 'mb_convert_encoding' ) ) {
	$_title = mb_convert_encoding( $_title, $blog_charset, $charset );
	$_excerpt = mb_convert_encoding( $_excerpt, $blog_charset, $charset );
	$_blog_name = mb_convert_encoding( $_blog_name, $blog_charset, $charset );
}
